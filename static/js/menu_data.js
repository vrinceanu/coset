        ...
        sections: [
            {
                ...
                links: [
                    ...
                    {
                        text: "Vision, Mission & Strategic Plan",
                        href: "/about/vision-mission-strategic-plan/",
                    },
                    {
                        text: "Administration",
            ...
            },
            {
                ...
                links: [
                    {
                        text: "College By-Laws",
                        href: "/about/college-by-laws/",
                    },
                    {
                        text: "Board of Advisors",
                        href: "/about/board-of-advisors/",
                    },
                    {
            ...
            },
            {
                ...
                links: [
                    ...
                    { text: "Reports", href: "/about/reports/" },
        ...
        sections: [
            {
                ...
                links: [
                    {
                        text: "Undergraduate",
                        href: "https://tsu.edu/admissions/freshman.php",
                    },
                    {
                        text: "Graduate",
                        href: "https://tsu.edu/academics/colleges-and-schools/graduate-school/apply-now.php",
                    },
                    {
                        text: "International",
                        href: "https://tsu.edu/admissions/international/index.php",
                    },
                ],
            },
            {
            ...
            },
            {
                ...
                links: [
                    {
                        text: "Summer Programs & Internships",
                        href: "/internships/",
                    },
                    {
        ...
        sections: [
            {
                ...
                links: [
                    {
                        text: "Undergraduate",
                        href: "/programs/undergraduate-index/",
                    },
        ...
        sections: [
            {
                ...
                links: [
                    {
                        text: "Highlights & Strategic Areas",
                        href: "/research/highlights-strategic-areas",
                    },
                    {
                        text: "Research Committee",
                        href: "/research/committee/",
                    },
                    { text: "Seminars & Events", href: "/research/seminars/" },
                    {
                        text: "Student Research Opportunities",
                        href: "/research/student-opportunities/",
                    },
                    {
                        text: "Core Research Resources",
                        href: "/research/core-resources/",
                    },
                ],
            },
            {
                ...
                links: [
                    ...
                    {
                        text: "Transportation, Training, and Research",
                        href: "/research/ttr/",
                    },
                    {
                        text: "Innovative Transportation Research",
                        href: "/research/itr",
                    },
                    {
                        text: "Scientific Machine Learning for Material Science",
                        href: "/research/sciml-ms",
                    },
                ],
            },
            {
                ...
                links: [
                    {
                        text: "Microplastics Impact",
                        href: "/research/microplastics/",
                    },
                    {
                        text: "Geostatistical Intelligence",
                        href: "/research/geostats/",
                    },
                    {
                        text: "Digital Twins and Robotics",
                        href: "/research/digital-twins/",
                    },
                ],
            },
        ],
